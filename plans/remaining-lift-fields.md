...
**Status: A1 and A2 done — Phase A complete. Next: T1**, then Phase B. Keep this file synced as remaining [decisions below](#decisions-to-settle) land, per [AGENTS.md's Working Style](../AGENTS.md).
