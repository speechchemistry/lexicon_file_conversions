...
```
flat    tests/testthat/fixtures/csv2lift/note_and_phonology_notes_entries.csv
        tests/testthat/fixtures/csv2lift/note_and_phonology_notes_senses.csv
        → --tables tests/testthat/fixtures/csv2lift/note_and_phonology_notes

folder  tests/testthat/fixtures/csv2lift/note_and_phonology_notes/entries.csv
        tests/testthat/fixtures/csv2lift/note_and_phonology_notes/senses.csv
        → --tables tests/testthat/fixtures/csv2lift/note_and_phonology_notes
```
...
- **Filenames stop growing with the table count.** By the end of Phase D flat mode would be producing `note_and_phonology_notes_entry-relations.csv`; folder mode produces `entry-relations.csv`.
